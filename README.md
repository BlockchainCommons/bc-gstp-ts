...
**`gstp-ts`** is a secure, authenticated, transport-agnostic request/response protocol with distributed state held in Encrypted State Continuations.
...
[@blockchaincommons/gstp](https://www.npmjs.com/package/@blockchaincommons/gstp) is published to npm. Install it with your package manager of choice:
...
import {
  ...
  SealedEvent,
  VERSION,
} from "@blockchaincommons/gstp";
```

Runnable examples live in the [`examples/`](https://github.com/BlockchainCommons/gstp-ts/tree/master/examples) directory.

## Status - Beta

`gstp-ts` is currently under active development and in beta testing. It should not be used for production tasks until it has had further testing and auditing. See [Blockchain Commons' Development Phases](https://github.com/BlockchainCommons/Community/blob/master/release-path.md).
...
`@blockchaincommons/gstp` depends on `@blockchaincommons/components`, `@blockchaincommons/dcbor-compat`, `@blockchaincommons/envelope`, `@blockchaincommons/known-values`, `@blockchaincommons/rand`, `@blockchaincommons/xid` at runtime.
...
This `gstp-ts` project is either derived from or was inspired by:
...
As an open-source, open-development community, Blockchain Commons does not have the resources to provide direct support of our projects. Please consider the discussions area as a locale where you might get answers to questions. Alternatively, please use this repository's [issues](https://github.com/BlockchainCommons/gstp-ts/issues) feature. Unfortunately, we can not make any promises on response time.
